...
#define IQS266_ADDR 0x44

typedef struct {
	void (*bsp_init) (void);
	void (*bsp_delay_ms) (int);	
	void (*handshake) (void);
...
// bool iqs266_get_system_flags(system_flags_t* flags);
// bool iqs266_get_trackpad_flags(trackpad_flags_t* flags);
// bool iqs266_get_events_flags(event_flags_t* flags);
// bool iqs266_get_channels_status(channel_status_t* status);
